...
class DataIngestionConfig :
    def __init__(self,training_pipeline_config: TraingPipelineConfig):
        ...
        self.collection_name : str = training_pipeline.DATA_INGESTION_COLLEECTION_NAME
        self.database_name: str = training_pipeline.DATA_INGESTION_DATABASE_NAME

class DataValidationConfig :
    def __init__(self,training_pipeline_config: TraingPipelineConfig):
        self.data_validation_dir:str = os.path.join(
            training_pipeline_config.artifact_dir,training_pipeline.DATA_VALIDATION_VALID_DIR
        )
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_congig:TraingPipelineConfig):
        self.model_trainer_dir:str = os.path.join(training_pipeline_congig.artifact_dir,training_pipeline.MODEL_TRAINER_DIR_NAME)
